package com.example.news_cy.adapter;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			view = View.inflate(context,
					R.layout.fragment_news_listview_item, null);
			holder = new ViewHolder();
			holder.iv_icon = (ImageView) view
					.findViewById(R.id.iv_fragment_news_listview_icon);
			holder.tv_title = (TextView) view
					.findViewById(R.id.tv_fragment_news_listview_title);
			holder.tv_date = (TextView) view
					.findViewById(R.id.tv_fragment_news_listview_date);
			view.setTag(holder);
